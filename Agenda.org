...
** DONE Neue Ameisenart
Ich kann mir dabei drei Varianten vorstellen:
 + [X] Lasius Niger, dessen Emotionswechsel immer auf Verhältnisschätzungen basieren

 + [X] Lasius Niger, dessen Emotionswechsel immer auf Verhältnisschätzungen basieren, der aber noch bei Normaler
   Stimmung, falls gegnerische Ameisen anwesend sind (d.h. die Verhältnisse sind noch nicht so klar) ein Ruf-Pheromon
   versprüht, dass über Diffussion an andere Ameisen des eigenen Stamms herangetragen wird. Diese folgend dann dem
   Gradienten.
