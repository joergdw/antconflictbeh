...
** DONE Sonstiges [5/5]
 ...
 7) /Optional:/ Kompatibilitätsschicht Scala-Mason für implizite Typtransformierung (Int2D <-> (Int, Int); bzw.: Int3D <-> (Int,
    Int, Int)) hinzufügen.
...
** TODO Quelltext-Arbeiten [12/14]
 ...
 + [ ] Tote Ameisen werden sofort entfernt
 + [ ] In das Informationsobjekt zu einem Stamm kommen nun auch Dinge, wie die Erzeugerbeschreibung für Ameisen rein.
